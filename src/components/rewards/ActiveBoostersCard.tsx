    ...
    <Card className="border-primary/30 bg-gradient-to-br from-primary/5 to-transparent">
      ...
      <CardContent className="space-y-3">
        ...
        {hasActiveDoubleXP() && doubleXPExpiry ? (
          <div className="flex items-center justify-between bg-accent-warm/10 border border-accent-warm/30 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-medium text-accent-warm">Double XP Active!</div>
            ...
            <Badge className="bg-accent-warm text-accent-warm-foreground">2x</Badge>
          </div>
        ) : (
          functionalRewards
              ...
              <div key={reward.id} className="flex items-center justify-between bg-muted/50 rounded-lg p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Doubles points for 24 hours</div>
                  </div>
                </div>
        ...
        {hasStreakFreeze() && (
          <div className="flex items-center justify-between bg-primary/10 rounded-lg p-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-medium text-primary">Streak Freeze</div>
